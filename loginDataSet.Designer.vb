...
Namespace loginDataSetTableAdapters
    ...
    Partial Public Class loginTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `login` WHERE ((`UserID` = ?) AND ((? = 1 AND `Username` IS NULL) OR "& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `login` SET `Username` = ?, `Password` = ? WHERE ((`UserID` = ?) AND ((? ="& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.WindowsApp2.My.MySettings.Default.loginConnectionString
        End Sub
